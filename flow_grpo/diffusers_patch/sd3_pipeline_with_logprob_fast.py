...
def pipeline_with_logprob(
    ...
    with self.progress_bar(total=num_inference_steps) as progress_bar:
        for i, t in enumerate(timesteps):
            ...
            timestep = t.expand(latent_model_input.shape[0]).to(latent_model_input.dtype) # 1215添加.to
            # print("INNER CHECK", latent_model_input.dtype, prompt_embeds.dtype, pooled_prompt_embeds.dtype)
